...
namespace ThriveDevCenter.Server.Migrations
{
    ...
    [Migration("20210527173944_ChangeSecretUniqueIndexToBeTypeSpecific")]
    partial class ChangeSecretUniqueIndexToBeTypeSpecific
    {
            ...
            modelBuilder.Entity("ThriveDevCenter.Server.Models.ControlledServer", b =>
                {
                    ...
                    b.Property<long>("AvailableDiskSpace")
                        .HasColumnType("bigint")
                        .HasColumnName("available_disk_space");
