...
namespace RevolutionaryWebApp.Server.Migrations
{
    ...
    [Migration("20250117164521_AddSiteLayoutPart")]
    partial class AddSiteLayoutPart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.SiteLayoutPart", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_site_layout_part");

                    b.HasIndex("ImageId")
                        .HasDatabaseName("ix_site_layout_part_image_id");

                    b.HasIndex("PartType", "Order")
                        .IsUnique()
                        .HasDatabaseName("ix_site_layout_part_part_type_order");

                    b.ToTable("site_layout_part", (string)null);
                });
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.SiteLayoutPart", b =>
                {
                    b.HasOne("RevolutionaryWebApp.Server.Models.Pages.MediaFile", "Image")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_site_layout_part_media_files_image_id");
