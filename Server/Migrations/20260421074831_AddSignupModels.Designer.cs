...
namespace RevolutionaryWebApp.Server.Migrations
{
    ...
    [Migration("20260421074831_AddSignupModels")]
    partial class AddSignupModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.CiJob", b =>
                {
                    ...
                    b.Property<int>("OutputConnection")
                        .HasColumnType("integer")
                        .HasColumnName("output_connection");
                    ...
                    b.Property<long?>("ReservedByRunnerId")
                        .HasColumnType("bigint")
                        .HasColumnName("reserved_by_runner_id");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_ci_jobs_created_at");

                    b.HasIndex("ReservedByRunnerId")
                        .IsUnique()
                        .HasDatabaseName("ix_ci_jobs_reserved_by_runner_id");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.CrashReport", b =>
                {
                    ...
                    b.Property<string>("UploadStoragePath")
                        .HasColumnType("text")
                        .HasColumnName("upload_storage_path");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.EmailBounce", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("BackoffWeeks")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("backoff_weeks");

                    b.Property<bool>("DisabledBySystem")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("disabled_by_system");
                    ...
                    b.Property<DateTime>("FirstBounceUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("first_bounce_utc");

                    b.Property<DateTime>("LastBounceUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_bounce_utc");
                    ...
                    b.Property<int>("OutstandingBounces")
                        .HasColumnType("integer")
                        .HasColumnName("outstanding_bounces");

                    b.HasKey("Id")
                        .HasName("pk_email_bounces");

                    b.HasIndex("Email")
                        .HasDatabaseName("ix_email_bounces_email");

                    b.HasIndex("NormalizedEmail")
                        .HasDatabaseName("ix_email_bounces_normalized_email");

                    b.ToTable("email_bounces", (string)null);
                });

            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Emails.DirectEmailPreferences", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("AllowCommitBuildStatus")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_commit_build_status");

                    b.Property<bool>("AllowConfirmEmail")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_confirm_email");
                    ...
                    b.Property<bool>("AllowPushBuildStatus")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_push_build_status");

                    b.Property<bool>("AllowSiteAnnouncement")
                        .HasColumnType("boolean")
                        .HasColumnName("allow_site_announcement");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("created_at");

                    b.Property<bool>("DisableAllEmails")
                        .HasColumnType("boolean")
                        .HasColumnName("disable_all_emails");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_direct_email_preferences");

                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("ix_direct_email_preferences_email");

                    b.HasIndex("NormalizedEmail")
                        .IsUnique()
                        .HasDatabaseName("ix_direct_email_preferences_normalized_email");

                    b.ToTable("direct_email_preferences", (string)null);
                });

            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Emails.UserEmailPreferences", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId")
                        .HasName("pk_user_email_preferences");

                    b.ToTable("user_email_preferences", (string)null);
                });
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Mailbox", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime?>("LastCleanUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_clean_utc");

                    b.Property<DateTime?>("LastReadEmailUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_read_email_utc");

                    b.Property<DateTime?>("LastReceivedEmailUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_received_email_utc");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.MediaFile", b =>
                {
                    ...
                    b.HasAlternateKey("GlobalId")
                        .HasName("ak_media_files_global_id");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.MediaFileUsage", b =>
                {
                    b.Property<long>("UsedByResource")
                        .HasColumnType("bigint")
                        .HasColumnName("used_by_resource");
                    ...
                    b.Property<Guid>("MediaFileGuid")
                        .HasColumnType("uuid")
                        .HasColumnName("media_file_guid");

                    b.HasKey("UsedByResource", "Usage", "MediaFileGuid")
                        .HasName("pk_media_file_usages");

                    b.HasIndex("MediaFileGuid")
                        .HasDatabaseName("ix_media_file_usages_media_file_guid");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.MediaFolder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 8, 4, 19, 0, 0, 0, DateTimeKind.Utc),
                            DeleteIfEmpty = false,
                            FolderModifyAccess = 5,
                            Name = "Website Parts",
                            SubFolderModifyAccess = 4,
                            UpdatedAt = new DateTime(2024, 8, 4, 19, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 2L,
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.PageRedirect", b =>
                {
                    ...
                    b.HasKey("FromPath")
                        .HasName("pk_page_redirects");

                    b.ToTable("page_redirects", (string)null);
                });
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.SiteLayoutPart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_site_layout_parts");

                    b.HasIndex("ImageId")
                        .HasDatabaseName("ix_site_layout_parts_image_id");

                    b.HasIndex("PartType", "Order")
                        .IsUnique()
                        .HasDatabaseName("ix_site_layout_parts_part_type_order");

                    b.ToTable("site_layout_parts", (string)null);
                });
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.VersionedPage", b =>
                {
                    ...
                    b.HasIndex("PublishedAt", "Visibility")
                        .HasDatabaseName("ix_versioned_pages_published_at_visibility");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.PendingUserSignup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime?>("LastEmailSentUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_email_sent_utc");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pending_user_signups");

                    b.HasIndex("NormalizedEmail")
                        .IsUnique()
                        .HasDatabaseName("ix_pending_user_signups_normalized_email");

                    b.ToTable("pending_user_signups", (string)null);
                });
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.RemoteRunner", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("CurrentConnectionId")
                        .HasColumnType("integer")
                        .HasColumnName("current_connection_id");
                    ...
                    b.Property<bool>("DisallowJobs")
                        .HasColumnType("boolean")
                        .HasColumnName("disallow_jobs");

                    b.Property<string>("HashedAccessId")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("hashed_access_id");

                    b.Property<DateTime?>("LastHeartbeat")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_heartbeat");

                    b.Property<IPAddress>("LastIpAddress")
                        .HasColumnType("inet")
                    ...
                    b.Property<bool>("QueuedCleanUp")
                        .HasColumnType("boolean")
                        .HasColumnName("queued_clean_up");
                    ...
                    b.Property<int>("TotalJobsTaken")
                        .HasColumnType("integer")
                        .HasColumnName("total_jobs_taken");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_remote_runners");

                    b.ToTable("remote_runners", (string)null);
                });
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.User", b =>
                {
                    ...
                    b.Property<long>("UploadQuotaUsed")
                        .HasColumnType("bigint")
                        .HasColumnName("upload_quota_used");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.CiJob", b =>
                {
                    b.HasOne("RevolutionaryWebApp.Server.Models.RemoteRunner", "ReservedByRunner")
                        .WithOne("ReservedJob")
                        .HasForeignKey("RevolutionaryWebApp.Server.Models.CiJob", "ReservedByRunnerId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_ci_jobs_remote_runners_reserved_by_runner_id");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Emails.UserEmailPreferences", b =>
                {
                    b.HasOne("RevolutionaryWebApp.Server.Models.User", "User")
                        .WithOne("EmailPreferences")
                        .HasForeignKey("RevolutionaryWebApp.Server.Models.Emails.UserEmailPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_email_preferences_users_user_id");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.MediaFileUsage", b =>
                {
                    b.HasOne("RevolutionaryWebApp.Server.Models.Pages.MediaFile", "MediaFile")
                        .WithMany("Usages")
                        .HasForeignKey("MediaFileGuid")
                        .HasPrincipalKey("GlobalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_media_file_usages_media_files_media_file_guid");
            ...
            modelBuilder.Entity("RevolutionaryWebApp.Server.Models.Pages.SiteLayoutPart", b =>
                {
                    b.HasOne("RevolutionaryWebApp.Server.Models.Pages.MediaFile", "Image")
                        .WithMany("UsedInSiteParts")
                        .HasForeignKey("ImageId")
                        .HasPrincipalKey("GlobalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_site_layout_parts_media_files_image_id");
