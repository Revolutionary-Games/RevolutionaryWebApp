...
namespace ThriveDevCenter.Server.Migrations
{
    ...
    [Migration("20220106152821_AddReporterEmailToCrashReport")]
    partial class AddReporterEmailToCrashReport
    {
            ...
            modelBuilder.Entity("ThriveDevCenter.Server.Models.CrashReport", b =>
                {
                    ...
                    b.HasIndex("PrimaryCallstack")
                        .HasDatabaseName("ix_crash_reports_primary_callstack");
