...
/// <summary>
///   Converts media links from internal format to one that browsers can use
/// </summary>
public interface IMediaLinkConverter
{
    /// <summary>
    ///   Translates image links to final URLs to display images. This cannot be used to get original size of the
    ///   image.
    /// </summary>
    /// <returns>A link to be used in HTML image tag</returns>
